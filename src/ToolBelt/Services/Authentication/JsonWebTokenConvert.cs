...
namespace ToolBelt.Services.Authentication
{
    ...
    public static class JsonWebTokenConvert
    {
        ...
        /// Thrown if the verify parameter was true and the signature was NOT valid or if the JWT was
        /// signed with an unsupported algorithm.
        /// </exception>
        ...
        private static JwtHashAlgorithm GetHashAlgorithm(string algorithm)
        {
            switch (algorithm)
            {
                ...
                default: throw new ArgumentException("Algorithm not supported.", nameof(algorithm));

                    // TODO: Uncommentdefault: throw new SignatureVerificationException("Algorithm not supported.");
            }
        }
    }
}
